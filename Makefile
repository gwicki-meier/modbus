...
DOCKER_RUN := docker run --init --rm -v $$PWD:/go/src/github.com/gwicki-meier/modbus -w /go/src/github.com/gwicki-meier/modbus
...
test:
	...
	go test -v -count=1 github.com/gwicki-meier/modbus/cmd/modbus-cli 
